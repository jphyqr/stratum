// app/(stratum)/how-stratum-works/page.tsx
"use client"
    ...
    <article className="mx-auto max-w-4xl space-y-12 py-8">
      ...
      <header className="space-y-4">
        ...
        <p className="text-xl text-muted-foreground">
          Understanding how Stratum uses your documentation to power AI-assisted
          development
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground">
          This page serves two purposes: it provides documentation for
          developers using Stratum, and it contains structured content that
          Stratum uses to understand your application.
        </p>
        ...
        <Alert>
          ...
          <AlertDescription>
            The content in the Application Context section below is used by
            Stratum to understand your application. You can modify this content
            to provide custom instructions and context for AI-assisted
            development.
          </AlertDescription>
        </Alert>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              Stratum extracts content from sections marked with specific IDs
            </li>
            <li>
              This content is used to provide context when generating code
            </li>
            <li>
              You can add additional documentation pages that Stratum will read
            </li>
      ...
      <section id="stratum-instructions" className="space-y-6">
        ...
        <div className="prose prose-gray max-w-none">
          <p>
            This application is built using Next.js 14 with the App Router. It
            follows a layer-based architecture pattern where functionality is
            organized into distinct, composable layers.
          </p>

          <h3>Core Principles</h3>
          <ul>
            <li>
              Each route group represents a distinct section of the application
            </li>
            <li>
              Components are co-located with their routes when specific to that
              route
            </li>
            <li>Shared components live in the root components directory</li>
            <li>
              Authentication is handled via Next-Auth with role-based access
            </li>
          </ul>
      ...
      <section className="space-y-6">
        ...
        <p>To customize how Stratum understands your application:</p>
        <ol className="list-decimal space-y-2 pl-6">
          <li>Modify the content in the Application Context section above</li>
          <li>
            Add additional documentation pages with the stratum-instructions ID
          </li>
          <li>Use the provided components to maintain consistent structure</li>
          <li>
            Keep instructions clear and specific to your applications needs
          </li>
        </ol>
      </section>
    </article>
