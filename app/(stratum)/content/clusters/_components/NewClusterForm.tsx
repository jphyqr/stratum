// app/(stratum)/content/_components/NewClusterForm.tsx
"use client"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., Product Strategy" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
                    ...
                    {field.value.map((persona, index) => (
                      <Badge key={index} className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const newPersonas = field.value.filter(
                              (_, i) => i !== index
                            )
