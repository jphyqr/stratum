// app/(stratum)/content/_components/KeywordTreeSkeleton.tsx

// app/(stratum)/content/_components/BriefListSkeleton.tsx
    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-1 items-center gap-2">
          <Skeleton className="h-4 max-w-[200px] flex-1" /> {/* Keyword text */}
