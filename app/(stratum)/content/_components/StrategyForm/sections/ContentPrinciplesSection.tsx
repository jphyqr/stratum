// app/(stratum)/content/_components/sections/ContentPrinciplesSection.tsx
...
export function ContentPrinciplesSection({
  form,
}: ContentPrinciplesSectionProps) {
  ...
  const removePrinciple = (index: number) => {
    const newPrinciples = principles.filter(
      (_principle: string, i: number) => i !== index
    )
