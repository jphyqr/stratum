// app/(docs)/content/_components/ContentView.tsx
"use client"
  ...
  async function generateStrategy() {
    ...
    try {
      ...
      const parsedStrategy = {
        ...data,
        thoughtLeadership: data.thoughtLeadership ? JSON.parse(data.thoughtLeadership) : null,
        industryContext: data.industryContext ? JSON.parse(data.industryContext) : null,
        targetPersonas: data.targetPersonas ? JSON.parse(data.targetPersonas) : []
      }
      router.refresh()
