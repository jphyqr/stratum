...
// app/(docs)/content/_components/KeywordList.tsx
...
export async function KeywordTree({ promise, clusterId, showTree }: KeywordListProps) {
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col items-center justify-center space-y-4 py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Generate keywords to start building your content hierarchy</p>
          </div>
