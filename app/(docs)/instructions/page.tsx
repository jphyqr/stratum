...
type ProjectStartType = 'NEED_TEMPLATE' | 'FRESH_TEMPLATE' | 'EXISTING';
 export interface Pattern {
  ...
  export type LayerCategory = 'IDEOLOGY' | 'COMMUNICATION' | 'ARCHITECTURE' | 'BUSINESS' | 'DESIGN' | 'SEO' | 'FEATURES' | 'UTILITIES' | 'ANALYTICS' | 'ACCESSIBILITY' | 'PERFORMANCE' | 'LIBRARIES' | 'COMPONENTS';
